...
def calc_porcentaje(total_lineas, lineas_funcion):
    porcentaje = int(round((lineas_funcion * total_lineas) / 100, 0))
    return porcentaje
...
salida = open("./salidas_modulos/participacion.txt", "w")

dic_participacion = carga_dic_participacion(fuente_unico, comentarios)
total_lineas = calc_total_lineas(dic_participacion)
imprimir_info_desarrollador(total_lineas)
escribir_info_desarrollador(salida, total_lineas)
