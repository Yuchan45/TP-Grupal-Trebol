def buscar_funcion_modulo(linea):
    """[Autor: Yuchan]
       [Ayuda: Recibe una linea por parametro y devuelve el nombre de la funcion, concatenado con el modulo al que pertenece]
    """
    lista = linea.split(",")
    for campo in lista:
        if ".py" in campo:
...
def count_lineas_codigo(linea):
    """[Autor: Yuchan]
       [Ayuda: Recibe una linea de un archivo de fuente_unico abierto y devuelve la cantidad de lineas de codigo en la funcion.]
    """
    lista_sin_vacios = []  
